...
<body>
                                    ...
                                    <form action="proses_login.php" method="POST">
                                        ...
                                        <div class="form-outline mb-5">
                                            ...
                                            <label class="form-label" for="confirm_password"
                                                style="color: #3b11a4;">Konfirmasi Password</label>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" onclick="resetPw()">Perbarui Password</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    function validatePassword() {
        if (passwordInput.value !== confirmInput.value) {
            confirmInput.setCustomValidity("Password salah, seperti aku yang selalu disalahkan:)");
        } else {
